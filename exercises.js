...
var tacoFiest = checkDifference(difference);
console.log(tacoFiest);
...
var sumDiff=addThenSubtract(bango3,bango4,bango5);
console.log(sumDiff);
...
var prodQuo = multiplyThenDivide(bango3,bango4,bango5);
console.log(prodQuo);

/* ALTERNATE VERSION
function multiplyThenDivide2(num1,num2,num3) {
    return multiply(multiply(num1,num2),1/num3);
}
var prodQuo2 = multiplyThenDivide2(bango3,bango4,bango5);
console.log(prodQuo2);
*/
...
var myFullName = createFullName('luke','fiorio');
...
var myBreakfast = eatFood('luke','fiorio','tacos');
...
var shoeSizeCm = shoeSize(10);
console.log(shoeSizeCm);
...
var yelling = allCaps('i am a little hungry.');
console.log(yelling);
...
var proper = oneCap('i am a little hungry.');
console.log(proper);
